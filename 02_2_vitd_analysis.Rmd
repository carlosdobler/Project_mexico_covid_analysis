...
func_pw2(df_20_60[,-c(1:3,11)], "Lat")
```

#### Age
```{r, fig.width = 10, fig.asp = 0.2}
func_pw2(df_20_60[,-c(1:3,11)], "Age")
```

#### Altitud
```{r, fig.width = 10, fig.asp = 0.2}
func_pw2(df_20_60[,-c(1:3,11)], "Altitude")
```

#### BMI
```{r, fig.width = 10, fig.asp = 0.2}
func_pw2(df_20_60[,-c(1:3,11)], "BMI")
```

#### Diabetes
```{r, fig.width = 10, fig.asp = 0.2}
func_pw2(df_20_60[,-c(1:3,11)], "Diab")
```

#### Hypertension
```{r, fig.width = 10, fig.asp = 0.2}
func_pw2(df_20_60[,-c(1:3,11)], "Hypert")
```

#### Sugar
```{r, fig.width = 10, fig.asp = 0.2}
func_pw2(df_20_60[,-c(1:3,11)], "Sugar")
```

#### Vitamin D
```{r, fig.width = 10, fig.asp = 0.2}
func_pw2(df_20_60[,-c(1:3,11)], "vitD")
```
...
#### How are Deaths/ht related to other individual variables?
```{r, fig.width = 10, fig.asp = 0.2}
func_pw2(df_mun_60[,c(3,5,9,10)], "Deaths_ht")
```
