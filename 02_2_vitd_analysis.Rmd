...
func_pw2(df_vitd[,-(2:3)], "Lat_zone")
#func_pw(df_vitd, Lat_zone)
...
#### Age
```{r, fig.width = 10, fig.asp = 0.2}
func_pw2(df_vitd[,-(2:3)], "Age")
```


#### Altitud
```{r, fig.width = 10, fig.asp = 0.2}
func_pw2(df_vitd[,-(2:3)], "Altitude")
```

#### BMI
```{r, fig.width = 10, fig.asp = 0.2}
func_pw2(df_vitd[,-(2:3)], "BMI")
```

#### Diabetes
```{r, fig.width = 10, fig.asp = 0.2}
func_pw2(df_vitd[,-(2:3)], "Diab")
```

#### Hypertension
```{r, fig.width = 10, fig.asp = 0.2}
func_pw2(df_vitd[,-(2:3)], "Hypert")
```

#### Sugar
```{r, fig.width = 10, fig.asp = 0.2}
func_pw2(df_vitd[,-(2:3)], "Sugar")
```

#### Vitamin D
```{r, fig.width = 10, fig.asp = 0.2}
func_pw2(df_vitd[,-(2:3)], "vitD")
```
...
lm(vitD ~ BMI + Lat_zone + Altitude, data = df_vitd) %>% summary()
...
lm(vitD ~ Lat_zone + Altitude, data = df_vitd) %>% summary()
